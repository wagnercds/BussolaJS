...
function bussola(Grau, Divisao, Desenho) 
{
 	var jg = new jsGraphics(Divisao);
 		
	jg.setStroke(5);
	jg.setColor("#ff0000"); 	
 	jg.drawImage(Desenho,0,0,150,156);
 	jg.drawLine(74,74,74-50*Math.cos(Math.PI/180*Grau+Math.PI/2),74-50*Math.sin(Math.PI/180*Grau+Math.PI/2));		 		
 	jg.paint();	
}